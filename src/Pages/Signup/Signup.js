        ...
        <section className='py-[100px] flex justify-center'>
            <div class="p-4 w-full max-w-sm bg-white rounded-lg border border-gray-200 shadow-md sm:p-6 md:p-7">
                <form class="space-y-6" action="#">
                    <h5 class="text-xl font-medium text-gray-900 text-center">Sign Up</h5>
                    <div>
                    ...
                    <button type="submit" class="w-full text-white bg-accent hover:bg-accent focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Sign Up</button>
                    <div class="text-sm font-medium text-center !mt-3">
                        Already have an account? <Link to="/login" class="text-secondary hover:underline">Log In</Link>
                    </div>
                </form>
